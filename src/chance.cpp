...
namespace cell_world {
    ...
    uint32_t
    Chance::pick_by_chance(const std::vector<double> &values, const std::vector<uint32_t> &chances, uint32_t dice) {
    ...
    std::vector<uint32_t>
    Chance::combine_chances(const std::vector<uint32_t> &chances1, const std::vector<uint32_t> &chances2) {
